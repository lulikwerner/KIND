    ...
    {<div style={{ marginBottom: "25px" }}>
      ...
      {showWaiver && (
        ...
        >
          ...
          >
            <h2>K.I.N.D. Ride for Miles Waiver Agreement</h2>
            ...
            >
              <ol>
                ...
                <li>
                  It is my express intent that this Release and Hold Harmless Agreement shall bind the members of my family and spouse, if I am alive, and my heirs, personal representatives, executors and assigns, if I am deceased, and shall be deemed as a RELEASE, WAIVER, DISCHARGE AND COVENANT NOT TO SUE the above named RELEASEES. I hereby further agree that this Waiver of Liability and Hold Harmless Agreement shall be construed in accordance with the laws of the State of Florida. If any portion of this Agreement is held to be invalid, it is agreed that the balance shall, notwithstanding, continue in full legal force and effect.
                </li>

                <li>
                  I understand while participating in THE ACTIVITY, I may be photographed. I agree to allow my photo, video, or film likeness to be used for any legitimate purpose the RELEASEES decide, and assigns.
                </li>
              </ol>
